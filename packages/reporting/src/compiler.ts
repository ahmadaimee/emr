...
export const STANDARD_REPORTS: Record<string, ReportQuery> = {
  ...
  underpayments_by_payer: { dataset: 'underpayments', measures: ['underpaid_line_count', 'underpaid_amount', 'expected_amount', 'underpayment_rate'], dimensions: [{ key: 'payer_name' }], filters: [{ key: 'has_underpayment', op: 'eq', values: [true] }], sort: [{ key: 'underpaid_amount', dir: 'desc' }] },
  underpayments_by_procedure: { dataset: 'underpayments', measures: ['underpaid_line_count', 'underpaid_amount', 'underpayment_rate'], dimensions: [{ key: 'procedure_code' }], filters: [{ key: 'has_underpayment', op: 'eq', values: [true] }], sort: [{ key: 'underpaid_amount', dir: 'desc' }] },
};
